...
Tato část obsahuje vypracované otázky na SZZ na KMI UPOL pro bakalářské studium informatiky se specializací programování a vývoj software. Otázky byly zpracovány v roce 2025. Otázky vychází z tohoto [repozitáře](https://github.com/Screedy/UPOL-SZZ-Otazky).
...
Při publikování aplikací na Google Play Store a Apple App Store je nutné zveřejnit tzv *Privacy policy*. Na podobu zveřejnění jsou kladeny různé nároky - nesmí se jednat o PDF dokument nebo Markdown soubor na GitHub. Zde jsou dostupné tyto zásady pro dvě aplikace, které spravuji pro [umimplavat.cz](https://umimplavat.cz/).

- [[published-apps/Aqua Points Calculator]]
- [[published-apps/Swim Time Calculator]]
